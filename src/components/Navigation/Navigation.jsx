    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
      <div className="navbar-collapse">
        <div className="navbar-nav mx-1 h5">
          <Link to="#" className="nav-item nav-link disabled">Portofolio</Link>
          <Link to="/" className="nav-item nav-link text-white">About Me</Link>
          ...
          <Link to="/experience" className="nav-item nav-link text-white">Experience</Link>
        </div>
      </div>
    </nav>
  )
